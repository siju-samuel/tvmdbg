...
from . import debugger_cli_common
from . import evaluator
from . import ui_factory
from ..util import debug_graphs
from ..util import source_utils
...
class DebugAnalyzer(object):
  ...
  def node_info(self, args, screen_info=None):
    ...
    # term "partition graph" means and how it is related to TVM graph objects
    # in Python. The information can be along the line of:
    # "A TVM graph defined in Python is stripped of unused ops
  ...
  def _make_source_table(self, source_list, is_tvm_py_library):
